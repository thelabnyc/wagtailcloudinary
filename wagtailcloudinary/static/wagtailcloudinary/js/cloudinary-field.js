(function ($) {
    ...
    $(document).ready(function () {
                ...
                onload: {
                    chooser: function (modal) {
                        function ajaxifyLinks(context) {
                            $(".listing a.image-choice", context).click(
                                function () {
                                    modal.loadUrl(this.href);
                                    return false;
                                },
                            );
                            $(".wagtailcloudinary-tag-wrapper a").click(
                                function (e) {
                                    e.preventDefault();
                                    $(this).parent().remove();
                                },
                            ...
                            $(".js-wagtailcloudinary-update-tags").click(
                                function (e) {
                                    e.preventDefault();
                                    $(
                                        ".wagtailcloudinary-overlay",
                                        $(this).closest(
                                            ".wagtailcloudinary-item",
                                        ),
                                    ).fadeIn();
                                },
                            );

                            $(".js-wagtailcloudinary-update").click(function (
                                e,
                            ) {
                                e.preventDefault();
                                var link = $(this);
                                ...
                                var addedtags = $('input[type="text"]', overlay)
                                    .val()
                                    .split(",");
                                var newtags = [];
                                $(
                                    ".wagtailcloudinary-tags-holder .tag",
                                    overlay,
                                ).each(function () {
                            ...
                            $(".js-wagtailcloudinary-update-cancel").click(
                                function (e) {
                                    e.preventDefault();
                                    $(this)
                                        .closest(".wagtailcloudinary-overlay")
                                        .fadeOut();
                                },
                            );
                        }
                        ...
                        function init_loadmore() {
                            ...
                            $(".js-wagtailcloudinary-more").on(
                                "click",
                                function (e) {
                                    e.preventDefault();
                                    var link = $(this);
                                    $.get(link.data("ajax-url"), {
                                        next: link.data("next"),
                                        tag: link.data("tag"),
                                    }).done(function (data) {
                                        $(
                                            ".wagtailcloudinary-wrapper .listing",
                                        ).append(data.html);
                                        if (data.next) {
                                            link.show();
                        ...
                        function init_tags() {
                            ...
                            $(".js-wagtailcloudinary-tag").on(
                                ...
                                function (e) {
                                    ...
                                    $(".status-tag", tags).removeClass(
                                        "icon icon-view",
                                    );
                                    $(".status-tag" + tagclass, tags).addClass(
                                        "icon icon-view",
                                    );
                                    $.get(link.attr("href"), { tag: tag }).done(
                                        function (data) {
                                            $(
                                                ".wagtailcloudinary-wrapper .listing",
                                            ).html(data.html);
                                ...
                                pasteZone: null,
                                    ...
                                    $.each(
                                        ...
                                        function (index, image) {
                                            $(
                                                ".wagtailcloudinary-upload-wrapper .listing",
                                            ).append(image.html);
                                            ajaxifyLinks(modal.body);
                                            $(".progress .bar").css({
                                                width: "0%",
        ...
        $(".objects").on("click", ".js-wagtailcloudinary-clear", function (e) {
            ...
            $("#preview_" + link.data("target")).attr(
                "src",
